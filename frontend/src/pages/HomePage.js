...
const HomePage = () => {
    ...
    useEffect(() => {
        // Hide homepage details on subroutes
        if (["/about-me", "/skills", "/projects"].includes(location.pathname)) {
    ...
    const getButtonStyle = (path) => {
        return location.pathname === path
            ? "bg-customBtn shadow-lg"
            : "text-customText bg-white hover:bg-gray-200 transition-all";
    };
    ...
    return (
        <div className="bg-customGray-light pt-16 text-customText">
            ...
            {showHomeDetails && (
                <div className="bg-customGray-dark h-auto p-5 flex flex-col lg:flex-row text-center lg:text-left items-center lg:items-start transition-all duration-300">
                    {/* Profile Image */}
                    <img
                        alt="Azhar Hussain"
            ...
            {/* Navigation Buttons */}
            <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start mb-4">
