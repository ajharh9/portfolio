...
const HomePage = () => {
    ...
    // Check if current route is one of the subroutes
    const isHomePage = !["/about-me", "/skills", "/projects"].includes(location.pathname);

    return (
        <div className="bg-customGray-light pt-16 text-customText">
            {/* Only show this section if we are on the homepage */}
            {isHomePage && (
