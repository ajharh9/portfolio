const AboutPage = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 text-gray-900 px-6 pb-20 pt-10">
            <div className="max-w-6xl mx-auto">
                {/* Header Section */}
                <div className="text-center mb-16">
                    <h1 className="text-5xl font-extrabold text-blue-900 mb-4 tracking-wide">👨‍💻 About Me</h1>
                    <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                        Hello, I’m <span className="font-semibold text-blue-900">Azhar Hussain</span>, a passionate and results-driven Product Developer with over <span className="font-semibold text-blue-900">2.5+ years of experience</span> specializing in backend technologies, financial systems, and performance optimization.
                    </p>
                </div>

                {/* Summary Section */}
                <section className="mb-16 px-6 py-4 bg-white shadow-lg rounded-lg max-w-4xl mx-auto">
                    <h2 className="text-3xl font-semibold text-blue-800 mb-6">🛠️ My Journey</h2>
                    <p className="text-lg text-gray-700">
                        I thrive on solving complex problems in the finance domain, working with advanced tools like <span className="font-semibold text-blue-900">C++, Java, Spring Boot</span>, and <span className="font-semibold text-blue-900">Oracle PL/SQL</span>. I design and optimize backend systems, develop microservices, and integrate external APIs to streamline workflows and enhance user experience.
                    </p>
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-semibold text-blue-800 mb-6">⚙️ My Technical Toolbox</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-lg text-gray-700">
                        <div className="p-4 bg-white shadow-md rounded-lg">
                            <h3 className="font-semibold text-blue-900 mb-2">Languages</h3>
                        ...
                        <div className="p-4 bg-white shadow-md rounded-lg">
                            <h3 className="font-semibold text-blue-900 mb-2">Databases</h3>
                            <p>Oracle, PostgreSQL, MySQL</p>
                        </div>
                        <div className="p-4 bg-white shadow-md rounded-lg">
                            <h3 className="font-semibold text-blue-900 mb-2">DevOps & Tools</h3>
                            <p>Git, Maven, Jenkins, Docker, Postman, Jira</p>
                        </div>
                        <div className="p-4 bg-white shadow-md rounded-lg">
                            <h3 className="font-semibold text-blue-900 mb-2">Systems & APIs</h3>
                ...
                <section className="mb-16">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                        <h3 className="text-2xl font-semibold text-blue-900 mb-2">Product Developer @ Infosys Finacle (EdgeVerve)</h3>
                ...
                {/* Education Section */}
                <section className="mb-16">
                    <h2 className="text-3xl font-semibold text-blue-800 mb-6">🎓 Education</h2>
                    <div className="bg-white shadow-md rounded-lg p-6">
                        <p className="font-medium text-blue-900">B.Tech in Electronics & Communication Engineering</p>
