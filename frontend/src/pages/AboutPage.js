  ...
  return (
    <div className="pt-16 pb-20 bg-gray-100 min-h-screen px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <InfoCard
          icon={<FaRocket className="text-gray-500 text-4xl mb-4" />}
        ...
        />
        <InfoCard
          icon={<FaTools className="text-gray-600 text-4xl mb-4" />}
          title="My Mission"
          points={[
        ...
        />
        <InfoCard
          icon={<FaUserTie className="text-gray-700 text-4xl mb-4" />}
      ...
      <div className="text-center mt-12">
        <Link
          to="/skills"
          className="inline-block bg-gray-800 text-white px-8 py-3 rounded-full font-semibold text-lg hover:scale-105 hover:shadow-lg transition-all"
        >
          Explore My Skills
        </Link>
      </div>
